...
//        if (brothMin.equals("") && !brothMax.equals("") && sistMin.equals("") && !sistMax.equals("")){
//            for (int i = 0; i < Student.studentsList.size(); i++){
//                if (brothMaxInt >= Student.studentsList.get(i).getBrotherNum()
//                        && sistMaxInt >= Student.studentsList.get(i).getSisterNum()){
//                    addThisStudent(i);
//                }
//            }
...
//        if (brothMin.equals("") && brothMax.equals("") && !sistMin.equals("") && sistMax.equals("")){
//            for (int i = 0; i < Student.studentsList.size();i++){
//                if (sistMinInt <= Student.studentsList.get(i).getSisterNum()){
//                    addThisStudent(i);
//                }
//            }
//            checkIsEmpty();
...
//        if (brothMin.equals("") && brothMax.equals("") && sistMin.equals("") && !sistMax.equals("")){
//            for (int i = 0; i < Student.studentsList.size();i++){
//                if (sistMaxInt >= Student.studentsList.get(i).getSisterNum()){
//                    addThisStudent(i);
//                }
//            }
//            checkIsEmpty();
